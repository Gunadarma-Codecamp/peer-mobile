...
/**
 * Created by christomas on 15/01/16.
 */
...
public class CameraQRCode extends ActionBarActivity {
    ...
    private void initControls() {
        ...
        mPreview = new QRPreview(CameraQRCode.this, mCamera, previewCb,
                autoFocusCB);
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            if (result != 0) {
                ...
                for (Symbol sym : syms) {
                    ...
                    Toast.makeText(CameraQRCode.this, scanResult,
